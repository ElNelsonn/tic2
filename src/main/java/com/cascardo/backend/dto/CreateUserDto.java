...
public record CreateUserDto (
    ...
    @Pattern(regexp = "^[a-zA-Z_áéíóúÁÉÍÓÚüÜñÑ'\\-]*$", message = "El nombre solo puede contener letras.")
    String name,

    @NotNull(message = "El apellido no puede ser nulo.")
    @Size(min = 1, max = 50, message = "El apellido debe contener entre 1 y 50 caracteres.")
    @Pattern(regexp = "^[a-zA-Z_áéíóúÁÉÍÓÚüÜñÑ'\\-]*$", message = "El apellido solo puede contener letras.")
    String lastName,
